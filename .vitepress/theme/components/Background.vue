...
.background {
  --pattern-dark: rgba(73, 73, 73, 0.08);
  --pattern-light: rgba(252, 252, 252, 0.08);
  ...
  &.pattern-dots {
    background-image: radial-gradient(circle, var(--pattern-color) 1.2px, transparent 1.2px);
  ...
  &.pattern-stars {
    background-image:
      radial-gradient(circle at 12px 18px, var(--pattern-color) 1px, transparent 1.5px),
      radial-gradient(circle at 42px 60px, var(--pattern-color) 1.2px, transparent 1.7px),
      radial-gradient(circle at 70px 24px, var(--pattern-color) 0.9px, transparent 1.4px),
      radial-gradient(circle at 88px 76px, var(--pattern-color) 1.1px, transparent 1.6px),
      radial-gradient(circle at 24px 88px, var(--pattern-color) 0.8px, transparent 1.3px),
      radial-gradient(circle at 58px 44px, rgba(255, 255, 255, 0.12) 0.8px, transparent 1.4px);
